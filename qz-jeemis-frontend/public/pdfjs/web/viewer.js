...
/***/ function (module, exports, __webpack_require__) {
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var PDFViewerApplication = {
      ...
      load: function load (pdfDocument) {
        ...
        firstPagePromise.then(function (pdfPage) {
          ...
          Promise.all([storePromise, pageModePromise]).then(function () {
            var _ref10 = _asyncToGenerator(/* #__PURE__ */_regenerator2.default.mark(function _callee8 (_ref9) {
              ...
              var _ref11$ = _ref11[0]
              var values = _ref11$ === undefined ? {} : _ref11$
              var pageMode = _ref11[1]
        ...
        pdfDocument.getMetadata().then(function (_ref12) {
          ...
          var contentDispositionFilename = _ref12.contentDispositionFilename
      ...
      setInitialView: function setInitialView (storedHash) {
        ...
        var rotation = _ref13.rotation
        var sidebarView = _ref13.sidebarView
        var scrollMode = _ref13.scrollMode
        var spreadMode = _ref13.spreadMode
    ...
    function webViewerPresentationModeChanged (evt) {
      ...
      var switchInProgress = evt.switchInProgress
    ...
    function webViewerUpdateFindControlState (_ref16) {
      ...
      var previous = _ref16.previous
      var matchesCount = _ref16.matchesCount
    ...
    var zoomDisabledTimeout = void 0
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    function getVisibleElements (scrollEl, views) {
      ...
      var viewBottom = void 0
      var hiddenHeight = void 0
      var currentWidth = void 0
      var viewWidth = void 0
      var viewRight = void 0
      var hiddenWidth = void 0
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var PDFCursorTools = (function () {
      function PDFCursorTools (_ref) {
        ...
        var cursorToolOnLoad = _ref$cursorToolOnLoad === undefined ? CursorTool.SELECT : _ref$cursorToolOnLoad
    ...
    var PDFAttachmentViewer = (function () {
      ...
      _createClass(PDFAttachmentViewer, [{
        ...
        value: function render (_ref2) {
          ...
          var _ref2$keepRenderedCap = _ref2.keepRenderedCapability
          var keepRenderedCapability = _ref2$keepRenderedCap === undefined ? false : _ref2$keepRenderedCap
        ...
        value: function open () {
          ...
          Promise.all([this.overlayManager.open(this.overlayName), this._dataAvailableCapability.promise]).then(function () {
            ...
            _this2.pdfDocument.getMetadata().then(function (_ref2) {
              ...
              var contentDispositionFilename = _ref2.contentDispositionFilename
              ...
              var info = _ref4[0]
              var metadata = _ref4[1]
              var fileName = _ref4[2]
              var fileSize = _ref4[3]
              var creationDate = _ref4[4]
              var modDate = _ref4[5]
              var pageSize = _ref4[6]
              var isLinearized = _ref4[7]
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var PDFFindController = (function () {
      function PDFFindController (_ref) {
        ...
        var _ref$eventBus = _ref.eventBus
        var eventBus = _ref$eventBus === undefined ? (0, _dom_events.getGlobalEventBus)() : _ref$eventBus
      ...
      _createClass(PDFFindController, [{
        ...
        value: function _calculateMatch (pageIndex) {
          ...
          var caseSensitive = _state.caseSensitive
          var entireWord = _state.entireWord
          var phraseSearch = _state.phraseSearch
      ...
      _createClass(PDFHistory, [{
        ...
        value: function initialize (fingerprint) {
          ...
          if (!this._isValidState(state) || resetHistory) {
            ...
            var hash = _parseCurrentHash.hash
            var page = _parseCurrentHash.page
            var rotation = _parseCurrentHash.rotation
        ...
        value: function _popState (_ref4) {
          ...
          if (!state || false) {
            ...
            var hash = _parseCurrentHash2.hash
            var page = _parseCurrentHash2.page
            var rotation = _parseCurrentHash2.rotation
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var PDFPresentationMode = (function () {
      function PDFPresentationMode (_ref) {
        ...
        var container = _ref.container
        var _ref$viewer = _ref.viewer
        var viewer = _ref$viewer === undefined ? null : _ref$viewer
        var pdfViewer = _ref.pdfViewer
        var eventBus = _ref.eventBus
        var _ref$contextMenuItems = _ref.contextMenuItems
        var contextMenuItems = _ref$contextMenuItems === undefined ? null : _ref$contextMenuItems
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var PDFThumbnailViewer = (function () {
      function PDFThumbnailViewer (_ref) {
        ...
        var l10n = _ref$l10n === undefined ? _ui_utils.NullL10n : _ref$l10n
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var PDFThumbnailView = (function () {
      function PDFThumbnailView (_ref) {
        ...
        var disableCanvasToImageConversion = _ref$disableCanvasToI === undefined ? false : _ref$disableCanvasToI
        var _ref$l10n = _ref.l10n
        var l10n = _ref$l10n === undefined ? _ui_utils.NullL10n : _ref$l10n
    ...
    var PDFViewer = (function (_BaseViewer) {
      ...
      _createClass(PDFViewer, [{
        ...
        value: function _scrollIntoView (_ref) {
          ...
          var pageSpot = _ref$pageSpot === undefined ? null : _ref$pageSpot
    ...
    var BaseViewer = (function () {
      ...
      _createClass(BaseViewer, [{
        ...
        value: function _scrollIntoView (_ref) {
          ...
          var pageNumber = _ref$pageNumber === undefined ? null : _ref$pageNumber
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var AnnotationLayerBuilder = (function () {
      function AnnotationLayerBuilder (_ref) {
        ...
        var imageResourcesPath = _ref$imageResourcesPa === undefined ? '' : _ref$imageResourcesPa
        var _ref$renderInteractiv = _ref.renderInteractiveForms
        var renderInteractiveForms = _ref$renderInteractiv === undefined ? false : _ref$renderInteractiv
        var _ref$l10n = _ref.l10n
        var l10n = _ref$l10n === undefined ? _ui_utils.NullL10n : _ref$l10n
      ...
      _createClass(SecondaryToolbar, [{
        ...
        value: function _bindClickListeners () {
          ...
          var _loop = function _loop (button) {
            ...
            var element = _buttons$button.element
            var eventName = _buttons$button.eventName
            var close = _buttons$button.close
            var eventDetails = _buttons$button.eventDetails
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    GenericExternalServices.createL10n = function (_ref3) {
      ...
      var locale = _ref3$locale === undefined ? 'en-US' : _ref3$locale
  ...
  /***/ function (module, exports, __webpack_require__) {
    ...
    var DownloadManager = (function () {
      function DownloadManager (_ref) {
        ...
        var disableCreateObjectURL = _ref$disableCreateObj === undefined ? DISABLE_CREATE_OBJECT_URL : _ref$disableCreateObj
