...
export default {
  ...
  actions: {
    ...
    updatePageTitle ({ state, commit, dispatch }, { fullPath, title }) {
      return new Promise(async resolve => {
    ...
    updateCurrentPageTitle ({ state, commit, dispatch }, { title }) {
      return new Promise(async resolve => {
        let pageOpendIndex = 0
